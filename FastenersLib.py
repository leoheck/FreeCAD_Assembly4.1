...
class insertFastener:
    ...
    def __init__(self, fastenerType):
        ...
        if  self.FSclass      == 'Screw':
            ...
            self.tooltip      = translate("Asm4_Fasteners", "<p>Insert a Screw into the Assembly</p>" + \
        ...
        # Nut
            ...
            self.tooltip      = translate("Asm4_Fasteners", "<p>Insert a Nut into the Assembly</p>" + \
            "<p>If another fastener is selected, a new fastener of the same type is created in the same assembly." + \
            "If an axis or LCS is selected, the new fastener will be attached to it." + \
            "If an assembly is selected, the new fastener will be inside that assembly.</p>")
        ...
        # Washer
            ...
            self.tooltip      = translate("Asm4_Fasteners", "<p>Insert a Washer into the Assembly</p>" + \
            "<p>If another fastener is selected, a new fastener of the same type is created in the same assembly." + \
            "If an axis or LCS is selected, the new fastener will be attached to it." + \
            "If an assembly is selected, the new fastener will be inside that assembly.</p>")
        ...
        # Threaded Rod (makes errors)
            ...
            self.tooltip      = translate("Asm4_Fasteners", "Insert threaded rod")
    ...
    def Activated(self):
        ...
        if len(Gui.Selection.getSelection())==1:
            ...
            # if a fastener is selected, we duplicate it
                ...
                try:
                    ...
                    FCC.PrintMessage(translate("Asm4_Fasteners", "Selected object doesn't seem to be a valid fastener, ignoring\n"))
        ...
        if fsType:
            ...
            if hasattr(newFastener,'length'):
                try:
                    ...
                    FCC.PrintMessage(translate("Asm4_Fasteners", "Length \"")+selObj.length+translate("Asm4_Fasteners", "\" is not available, ignoring\n"))
        ...
        try:
            ...
            FCC.PrintMessage(translate("Asm4_Fasteners", "unknown fastener type \"")+str(fsClass)+translate("Asm4_Fasteners", "\", ignoring\n"))
...
class cloneFastenersToAxesCmd():
    ...
    def GetResources(self):
        return {"MenuText": translate("Asm4_Fasteners", "Clone Fastener to Axes"),
                "ToolTip": translate("Asm4_Fasteners", "Clone Fastener to Axes"),
