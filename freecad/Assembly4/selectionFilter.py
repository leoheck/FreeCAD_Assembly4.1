...
class selectionFilterClearCmd:
    def GetResources(self):
        return {
            "MenuText": "Clear all selection filters",
    ...
    def addSelection(self, doc, obj, sub, pnt):
        ...
        if pnt != (0, 0, 0):
            ...
            if subObjName == "":
                for subObj in objList:
                    if (
                        subObj.TypeId == "App::Part"
                        or subObj.TypeId == "PartDesign::Body"
                        or subObj.isDerivedFrom("Part::Feature")
                    ):
