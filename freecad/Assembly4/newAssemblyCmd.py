    ...
    def Activated(self):
        ...
        if assy is not None:
            if assy.TypeId == "App::Part":
                ...
                message += (
                    "but it's of type \""
                    + assy.TypeId
                    + "\", unsuitable for an assembly. I can't proceed."
                )
                Asm4.warningBox(message)
            # abort
            return
        ...
        if ok and text:
            ...
            lcs0 = Asm4.newLCS(
                ...
                "LCS_Origin",
                [(assembly.Origin.OriginFeatures[0], "")],
            )
            ...
            if (
                hasattr(partsGroup, "TypeId")
                and partsGroup.TypeId == "App::DocumentObjectGroup"
            ):
                for obj in App.ActiveDocument.Objects:
                    if (
                        obj.TypeId in Asm4.containerTypes
                        and obj.Name != "Assembly"
