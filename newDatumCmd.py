...
class newDatum:
    ...
    def Activated(self):
        ...
        if parentContainer:
            ...
            text,ok = QtGui.QInputDialog.getText(None,translate("Asm4_createDatum", 'Create new ')+self.datumName,
                    translate("Asm4_createDatum", 'Enter ')+self.datumName+translate("Asm4_createDatum", ' name :')+' '*40, text = proposedName)
            if ok and text:
