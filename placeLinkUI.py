    ...
    def clicked(self, button):
        if button == QtGui.QDialogButtonBox.Apply:
            ...
            if self.selectedObj.ExpressionEngine :
                ...
                confirmed = Asm4.confirmBox(translate("Asm4_placePart", 'This command will release all attachments on '+msgName+' and set it to manual positioning in its current location.'))
